...
final class EarthquakesTests: XCTestCase {
    ...
    //  This function tries to decode the GeoJSON data, asserting that the code property in the Quake instance matches the corresponding value from the sample data.
